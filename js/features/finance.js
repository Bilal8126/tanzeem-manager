        ...
        : STATE.allDonations.map((d, i) => `
            <div class="finance-item">
              ...
              <div style="display:flex;align-items:center;gap:6px;flex-shrink:0">
                ...
                <button onclick="_quickProofUpload('Donation',${i})" title="Payment Proof" style="background:none;border:none;cursor:pointer;padding:5px 6px;color:#7c3aed;border-radius:8px;transition:background .15s;display:flex;align-items:center" onmouseover="this.style.background='#f5f3ff'" onmouseout="this.style.background='none'"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg></button>
                ${_isActiveSession() ? `
        ...
        : STATE.allExpenses.map((e, i) => `
            <div class="finance-item">
              ...
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <button onclick="_quickProofUpload('Expense',${i})" title="Receipt Proof" style="background:none;border:none;cursor:pointer;padding:5px 6px;color:#7c3aed;border-radius:8px;transition:background .15s;display:flex;align-items:center" onmouseover="this.style.background='#f5f3ff'" onmouseout="this.style.background='none'"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg></button>
                ${_isActiveSession() ? `
