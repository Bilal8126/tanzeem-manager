function renderDashboard() {
  ...
  document.getElementById('dashboardContent').innerHTML = `
    ...
    <div class="quick-actions">
      <div class="qa-btn" onclick="showScreen('members',document.querySelector('.nav-item'));setTimeout(openAddMember,80)">
      ...
      <div class="qa-btn" onclick="showScreen('finance',document.querySelectorAll('.nav-item')[3]);STATE.currentFinanceTab='donations';setTimeout(()=>openFinanceForm('donation'),80)">
      ...
      <div class="qa-btn" onclick="showScreen('finance',document.querySelectorAll('.nav-item')[3]);STATE.currentFinanceTab='expenses';setTimeout(()=>openFinanceForm('expense'),80)">
